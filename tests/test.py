...
from ids_parser import parse_ids_file, parse_ids_content, PropertyRequirement, PSetGroup
...
class TestParseIdsFile:
    ...
    def test_parse_multi_entity_ids(self):
        ...
        # Should have properties from both specifications
        assert len(pset.properties) == 2
        prop_names = [p.name for p in pset.properties]
